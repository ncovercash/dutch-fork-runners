...
define("PAGE_KEYWORD", "markdown");
define("PAGE_TITLE", "Markdown Help");

require_once Values::HEAD_INC;

echo UniversalFunctions::createHeading("Markdown Help");
?>
      <div class="row"><div class="col s12 m9 l10"><div class="section">
        <p class="flow-text">I use a modified version of Markdown to render certian areas of the site, typically descriptions or bodies.</p>
        <p class="flow-text">Markdown allows for text to be easily formatted while still being clean and simple.</p>
        <br>
        <p class="flow-text">In order to edit portions of this site, you will need to use this syntax.</p>
        <p class="flow-text">These files can be found in the "md" folder with fairly obvious names.</p>
        <p class="flow-text">In addition to the syntax here, you can use (most) HTML as well.</p>
      </div>
...
MD
      ...
      <div class="section" id="comments">
        <h4>Comments</h4>
        <p class="flow-text">You may use code-style comments (<span class="code">//</span>) at the beginning of a line to comment out (not show) a line.</p>
        <p class="flow-text">Additionally, block comments are supported using the standard (optionally multi-line) <span class="code">/* ... */</span> syntax.</p>
        <div class="row">
...
test6
*/
and an in-line /* example */ comment
MD
)
)) ?>
</p></div></div>
...
MD
      ...
      <div class="section" id="links">
        ...
        <p class="flow-text">All links are shown in bold, colored text.  This cannot be changed, however you may apply additional formatting such as italics.</p>
        <div class="row">
          <div class="col s12 m6"><div class="code-block"><p>
<?= implode("&nbsp;</p><p>", explode("\n", htmlspecialchars(<<<MD
https://dutchforkrunners.com

[The Best Site!](https://dutchforkrunners.com)

*For more information, check out the [home](https://dutchforkrunners.com) page.*
MD
)
)) ?>
</p></div></div>
...
MD
      ...
      <div class="section" id="checklists">
        ...
        <p class="flow-text">These can be parts of lists, tables, and any other features I support!</p>
        <div class="row">
          <div class="col s12 m6"><div class="code-block"><p>
<?= implode("&nbsp;</p><p>", explode("\n", htmlspecialchars(<<<MD
...
| column 3 is  | right-aligned | ~~cross this out~~      |
...
MD
      ...
      <div class="section" id="emoji">
        <h4>Emoji</h4>
        <p class="flow-text">Apparently these are useful for something?  Anyways, I support them.</p>
        <p class="flow-text">For our emoji, I use a limited set of <a href="https://github.com/twitter/twemoji">twemoji</a>.  To see all the emoji I support, go <a href="Emoji">here</a>.</p>
...
MD
      ...
      <div class="section" id="containers">
        <h4>Containers</h4>
        <p class="flow-text">I have created several custom containers for your use.  These are wrapped in at least three colons (<span class="code">:</span>) above and below the content.  The top set should have a token following it (i.e. <span class="code">::: token</span>).</p>
...
::::textcolor #2f0
:::backcolor #ff0
#### *This is a horrible use of color*
:::
::::
MD
)
